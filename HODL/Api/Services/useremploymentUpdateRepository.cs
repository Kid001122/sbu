...
{
    public class useremploymentUpdateRepository
    {
        public useremployment Update(useremployment useremploymentm)
        {
            int i = 0;
            ...
            {
                Conn.Open();
                string query = "Update useremployment Set    User = @User,    NameOfBusiness = @NameOfBusiness,    EmploymentStatus = @EmploymentStatus,    SourceOfFund = @SourceOfFund,    SourceOfCrypto = @SourceOfCrypto where UserEmploymentId=@UserEmploymentId";
