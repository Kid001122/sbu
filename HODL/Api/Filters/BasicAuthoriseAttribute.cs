...
namespace API.Filters
{
    ...
    public class BasicAuthoriseAttribute : AuthorizationFilterAttribute
    {

//        [Inject]
//        public LogonRepository TheRepository = new LogonRepository();
...
//                        if (TheRepository.Login(userName, password))
//                        {
